...
{
    public class MainContextGetemployees : DbContext, IGetemployees
    {



        public MainContextGetemployees(DbContextOptions<MainContextGetemployees> options)
            : base(options)
        {
        ...
        public IEnumerable<dynamic> Getemployees()
        {
            ...
            {
                command.CommandText = @"SELECT [empid]

...
{
    public class MainContextGetClientOrders : DbContext, IGetClientOrders
    {



        public MainContextGetClientOrders(DbContextOptions<MainContextGetClientOrders> options)
            : base(options)
        {
